...
namespace ASP_MVC.Controllers
{
    ...
    {
        private readonly ASP_MVCDbContext _context;

        public ContactListController(ASP_MVCDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactType,Name,DateOfBorth,PhoneNumber,Email")] ContactListEntry contactListEntry)
        {
